    ...
    partial class frmCorrect
    {
        ...
        private void formInitialize(string sID, int cIx)
        {
            ...
            if (sID == string.Empty)
            {
                ...
                // 合計欄
                txtZangyoTL.ReadOnly = false;
                txtShinyaTL.ReadOnly = false;
                txtKyujitsuTL.ReadOnly = false;
                txtChikokuTL.ReadOnly = false;
                txtSoutaiTL.ReadOnly = false;

                // 月間日数
                txtShukkin.ReadOnly = false;
                txtYukyu.ReadOnly = false;
                txtTokukyu.ReadOnly = false;
                txtKekkin.ReadOnly = false;
                txtSeiri.ReadOnly = false;
                txtJisa.ReadOnly = false;
                txtHoanH.ReadOnly = false;
                txtHoanK.ReadOnly = false;
                txtShukuH.ReadOnly = false;
                txtShukuK.ReadOnly = false;
                txt1L.ReadOnly = false;
                txt2Kin.ReadOnly = false;
                txt3Kin.ReadOnly = false;
                txtMaru3Kin.ReadOnly = false;
                txtshukujitsu.ReadOnly = false;
                txtKoujyoNissu.ReadOnly = false;
