...
namespace MTYS_OCR
{
    class global
    {
        ...
        #region ローカルMDB関連定数
        public const string MDBFILE = "MTYS.mdb";         // MDBファイル名
        public const string MDBTEMP = "MTYS_Temp.mdb";    // 最適化一時ファイル名
        public const string MDBBACK = "MTYS_Back.mdb";    // 最適化後バックアップファイル名
        #endregion
        ...
        // 帳票区分
        public const string C_HONSHA = "1";
        public const string C_SHIZUOKA = "2";
        public const string C_OOSAKA = "3";

        // 大阪製造部Ｇ
        public const string OOSAKAG_A = "A";
        public const string OOSAKAG_B = "B";
        public const string OOSAKAG_C = "C";
        public const string OOSAKAG_D = "D";
        ...
        public string[] arrayChohyoID = { "本社","静岡","大阪製造部" };
        ...
        // 祝日配列 ※日付が固定の祝日
        public static string[] sDay = {"01/01元旦","02/11建国記念の日","04/29昭和の日","05/03憲法記念日","05/04みどりの日",
                         "05/05こどもの日","11/03文化の日","11/23勤労感謝の日","12/23天皇誕生日"}; 
